 ...
 */
function backdrop_decanter_is_header($set)
{
  static $is_header;
  if (0 == strcmp($set, 'get')) {
    return $is_header;
...
function backdrop_decanter_preprocess_layout(&$variables)
{
  ...
  foreach ($layout->content as $key => $block) {
    if ($block->module == 'system' && $block->delta == 'header') {
      backdrop_decanter_is_header(true);
    }
  }
...
function backdrop_decanter_preprocess_header(&$variables)
{
  ...
  $navbar_menu_position = 'navbar-right';
  $variables['navbar_menu_position'] = 'd-flex justify-content-end';
  if ($navbar_position = theme_get_setting('backdrop_decanter_navbar_user_menu')) {
  ...
  if ($navbar_position = theme_get_setting('backdrop_decanter_navbar_position')) {
 ...
 */
function backdrop_decanter_links__header_menu($menu)
{
//  $menu['attributes']['class'] = array('menu', 'nav', 'navbar-nav');
//  $menu['attributes']['class'][] = $navbar_menu_position;
  $menu['attributes']['class'] = array('su-main-nav__menu-lv1');
 ...
 * Implements hook_links().
 */
function backdrop_decanter_links__user_menu($menu)
{
  if ($navbar_menu_position = theme_get_setting('backdrop_decanter_navbar_menu_position')) {
    $menu['attributes']['class'][] = $navbar_menu_position;
  }
  foreach ($menu['links'] as $item => $link) {
...
// */
function backdrop_decanter_menu_tree__user_menu($variables)
{
  if ($navbar_position = theme_get_setting('backdrop_decanter_navbar_user_menu')) {
 ...
 * @ingroup themeable
 */
function backdrop_decanter_fieldset($variables)
{
 ...
 * @ingroup themeable
 */
function backdrop_decanter_button($variables)
{
 ...
 * @ingroup themeable
 */
function backdrop_decanter_email($variables)
{
 ...
 * @ingroup themeable
 */
function backdrop_decanter_textfield($variables)
{
  $variables['element']['#attributes']['class'][] = 'form-control';
...
// * @ingroup themeable
// */
function backdrop_decanter_textarea($variables)
{
  $variables['element']['#attributes']['class'][] = 'form-control';
...
// * @ingroup themeable
// */
function backdrop_decanter_checkbox($variables)
{
...
// * @ingroup themeable
// */
function backdrop_decanter_radio($variables)
{
  $variables['element']['#attributes']['class'][] = 'form-check-input';
 ...
 * @ingroup themeable
 */
function backdrop_decanter_form_element($variables)
{
 ...
 * @ingroup themeable
 */
function backdrop_decanter_password($variables)
{
  $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function backdrop_decanter_search($variables)
{
 ...
 * @ingroup themeable
 */
function backdrop_decanter_select($variables)
{
 ...
 */
function backdrop_decanter_preprocess_table(&$variables)
{
 ...
 * @ingroup themeable
 */
function backdrop_decanter_user_permission_description($variables)
{
  $description = array();
 ...
 * @ingroup themeable
 */
function backdrop_decanter_admin_block($variables)
{
 ...
 * @ingroup themeable
 */
function backdrop_decanter_system_admin_index($variables)
{
 ...
 * @ingroup themeable
 */
function backdrop_decanter_admin_page($variables)
{
 ...
 */
function backdrop_decanter_menu_local_tasks(&$variables)
{
  $output = '';
 ...
 * Implements hook_links().
 */
function backdrop_decanter_links__dropbutton($menu)
{
 ...
 */
function backdrop_decanter_menu_local_actions(&$variables)
{
 ...
 */
function backdrop_decanter_preprocess_breadcrumb(&$variables)
{
  $breadcrumb = &$variables['breadcrumb'];

  // Optionally get rid of the homepage link.
  $show_breadcrumb_home = theme_get_setting('backdrop_decanter_breadcrumb_home');
  if (!$show_breadcrumb_home) {
    array_shift($breadcrumb);
  }
  if (theme_get_setting('backdrop_decanter_breadcrumb_title') && !empty($breadcrumb)) {
    $item = menu_get_item();
 ...
 * @ingroup themeable
 */
function backdrop_decanter_container($variables)
{
 ...
 */
function backdrop_decanter_preprocess_views_view_table(&$variables)
{
 ...
 */
function backdrop_decanter_form_alter(array &$form, array &$form_state = array(), $form_id = null)
{
  if ($form_id) {
 ...
 */
function backdrop_decanter_node_add_list($variables)
{
 ...
 */
function backdrop_decanter_admin_block_content($variables)
{
  return backdrop_decanter_node_add_list($variables);
}
 ...
 */
function backdrop_decanter_preprocess_user_picture(&$variables)
{
 ...
 */
function backdrop_decanter_preprocess_comment(&$variables)
{
  if (theme_get_setting('backdrop_decanter_datetime')) {
...
function backdrop_decanter_progress_bar($variables)
{
...
function backdrop_decanter_preprocess_paragraphs_item(&$variables, $hook)
{}
